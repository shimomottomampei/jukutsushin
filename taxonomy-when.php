...
<h1 class="posts__titles"><?php the_archive_title(); ?>の解説音声・動画一覧</h1>
...
<div class="posts__content"><!-- posts__content -->
  ...
  <div class="posts__right">
    ...
    <div>
      <?php echo get_the_term_list( $post->ID, 'kyoka', '<span class="cat '. $cat_slug. '">','</span><span class="cat '. $cat_slug. '">', '</span>' ); ?><?php echo get_the_term_list( $post->ID, 'when', '<span class="cat '. $cat_slug. '">','</span><span class="cat '. $cat_slug. '">', '</span>'); ?>
    </div>
  </div><!-- / posts__right -->
...
<a href="https://mrstepup-radio.com/archives/recommend/"><img loading="lazy" src="<?php echo wp_upload_dir()['baseurl']; ?>/2020/11/recom.png" alt="" width="900" height="141" class="alignnone size-full wp-image-396" style="max-width:100%; height:auto;"></a></p>
